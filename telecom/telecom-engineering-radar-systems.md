...
depends_on:
  ...
  - iot-engineering-industrial-iot-platform
  - telecom-5g-core
  - telecom-data-analyst
description: 雷达系统与射频探测技术专家，覆盖毫米波雷达(24/60/77GHz)/相控阵(AESA)设计、雷达信号处理(CFAR/DBF/Micro-Doppler)、汽车雷达/4D成像雷达与雷达系统链路预算
emoji: 📡
lifecycle: published
name: 雷达系统/射频感知工程师
nexus_roles:
...
|---|---|---|---|
| 📡 Radar Systems Engineer Agent Assessment Report | Structured document | Current state analysis, gap identification, root cause assessment | ISO 9001:2015 §9.1 |
