...
ROLE_RULES = {
    ...
    "cybersecurity": [
        (r"architect|csiso|chief|grc|compliance|audit|risk|privacy|dpo", ["phase-1-strategy"]),
    ...
    "security": [
        (r"architect|cloud-security", ["phase-1-strategy"]),
...
DEFAULT_BY_CATEGORY = {
    "healthcare": ["phase-3-build"],
    "pharma-biotech": ["phase-3-build"],
    "media-entertainment": ["phase-3-build"],
    "education": ["phase-3-build"],
    "spatial-computing": ["phase-3-build"],
    "network-engineering": ["phase-2-foundation"],
    "environmental": ["phase-3-build"],
    "agriculture": ["phase-3-build"],
    "energy": ["phase-3-build"],
    "manufacturing": ["phase-3-build"],
    "automotive": ["phase-3-build"],
    "aerospace": ["phase-3-build"],
    "construction": ["phase-3-build"],
    "logistics": ["phase-3-build"],
    "retail": ["phase-5-launch"],
    "real-estate": ["phase-5-launch"],
    "insurance": ["phase-3-build"],
    "tourism": ["phase-5-launch"],
    "food-beverage": ["phase-3-build"],
    "sports": ["phase-5-launch"],
    "fashion": ["phase-5-launch"],
    "publishing": ["phase-5-launch"],
    "telecom": ["phase-2-foundation"],
    "nonprofit": ["phase-6-operate"],
    "government": ["phase-1-strategy"],
    "emergency": ["phase-6-operate"],
    "mining": ["phase-3-build"],
    "forestry": ["phase-3-build"],
    "events": ["phase-5-launch"],
    "pets": ["phase-6-operate"],
    "beauty": ["phase-5-launch"],
    "libraries": ["phase-0-discovery"],
    "museums": ["phase-3-build"],
    "localization": ["phase-3-build"],
    "hr-tech": ["phase-3-build"],
    "lottery": ["phase-5-launch"],
    "securities": ["phase-3-build"],
    "administration": ["phase-6-operate"],
}
...
def assign_roles(agent_id, category):
    ...
    # Universal overrides: leadership roles always get strategy phases
    if re.search(r"director|chief|head-of|vp-|ceo|coo|cto|ciso|cfo|president|general-manager|gm-", agent_id, re.IGNORECASE):
        return ["phase-1-strategy"]
    ...
    if rules:
        for pattern, roles in rules:
            ...
            if re.search(pattern, agent_id, re.IGNORECASE):
                return roles
    return DEFAULT_BY_CATEGORY.get(category)
