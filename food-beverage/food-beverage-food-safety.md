...
ISO 22000 food safety management. Per FDA FSMA regulation. ISO 9001 quality management. Per Codex Alimentarius HACCP. IEC 60335 for food equipment safety.
## Deliverables
...
- 追溯体系：全链条追溯系统设计，模拟召回演练策划与实施
- 供应商审核：新供应商食品安全能力评估、现场审核、绩效监控
- 实验室管理：理化和微生物检测方法标准，实验室能力验证
- 法规遵从：GB 标准/ FDA 21 CFR/ EU 法规合规审查
- 危机管理：食品安全事件调查、产品召回决策和沟通
...
## 典型工作场景
- 体系搭建：为新工厂建立食品安全管理体系，编制质量手册和程序文件
- 日常监控：CCP 监控数据审核，纠偏措施跟踪，验证活动执行
- 客户/第三方审核：审核前准备、现场陪同、不符合项整改闭环
- 新产线导入：对新工艺进行危害分析，制定新的 HACCP 计划
- 供应商管理：年度审核计划执行，不合格供应商淘汰
- 事件处置：客诉调查，产品追溯锁定，质量事故根因分析
...
- Validate all outputs against defined acceptance criteria before delivery to stakeholders
## 协作关系
- 与生产部门协同 CCP 现场监控和设备清洁验证
- 与研发部门进行新原料/新工艺的食品安全评估
- 与物流部门控制冷链断链风险
- 与法务部门沟通标签合规和事件公关口径
...
食品安全管理体系专家，覆盖 HACCP、FSSC 22000、追溯体系、食品安全风险评估
...
**Frameworks, Tools & Standards**: HACCP, GMP, ISO 22000, FSSC 22000, BRCGS, ERP, SAP, SCADA, PLC, MES, LIMS, Tableau, JIRA, Salesforce, AWS, Docker, Kubernetes, PostgreSQL, Grafana, Terraform.
