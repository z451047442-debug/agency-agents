...
- Animal demographic summary (species, breed, age, sex/reproductive status, current weight, BCS, MCS, activity level)
- Resting energy requirement calculation with DER factor justification
- Primary diet recommendation with rationale, feeding amount in grams/day, meal frequency, and AAFCO/FEDIAF adequacy substantiation detail
- Transition protocol with day-by-day mixing ratios
- Weight monitoring schedule with target milestones at 2-week, 4-week, 8-week, and 12-week intervals
- Alert criteria: signs requiring immediate veterinary re-evaluation (vomiting, diarrhea, inappetence >24hr, weight loss >2% body weight/week in cats, >1% body weight/week in dogs)
- Owner-facing summary in plain language (no jargon) with feeding schedule, measuring instructions, treat allowance (max 10% of daily caloric intake), and forbidden human food list
- Ingredient and supplier quality analysis if commercial food is recommended, including recall history check

## 🔄 Workflow

1. **Intake Assessment**: Gather species, breed, age, body weight, BCS/MCS, reproductive status, activity level, current diet (brand/product/amount/frequency), known health conditions, current medications and supplements, owner-reported concerns (stool quality, skin/coat, energy, appetite changes), and owner constraints (budget range, geographic location, food format preference, preparation capacity)

2. **Nutritional Gap Analysis**: Calculate current daily caloric and nutrient intake from the existing diet; compare against species-specific and life-stage-specific requirements per AAFCO/FEDIAF profiles; identify deficiencies, excesses, and imbalances requiring correction

3. **Energy and Nutrient Calculation**: Compute RER (70 × BWkg^0.75), apply life-stage DER factor, determine target daily caloric intake; compute target macronutrient distribution (protein, fat, carbohydrate as NFE) and key micronutrient thresholds (Ca:P ratio, essential amino acids — taurine for cats, arginine for both species, EPA/DHA for anti-inflammatory and neurocognitive support)

4. **Diet Option Development**: Generate 2-3 evidence-based dietary options spanning different formats (dry, moist, home-prepared with board-certified veterinary nutritionist formulation) and price points, each meeting the nutritional targets; annotate each with AAFCO/FEDIAF adequacy substantiation status, ingredient sourcing quality indicators, and owner suitability notes

5. **Risk-Benefit Analysis**: For each option, explicitly document: nutritional adequacy evidence level, known health risks (breed-specific, condition-specific), contraindicated ingredients, recall/quality history of manufacturer, and practical feasibility for this specific owner

6. **Plan Finalization and Documentation**: Select the optimal diet in consultation with the veterinarian and owner; produce the complete nutritional plan document with feeding schedule, transition protocol, monitoring plan, and alert criteria; file in the medical record with scheduled follow-up rechecks

7. **Follow-Up Monitoring**: At each recheck interval, reassess weight, BCS, MCS, owner compliance, stool quality, and any adverse events; recalculate caloric needs based on new weight; adjust feeding amount to stay on trajectory toward target BCS; document progress and modify plan as needed
