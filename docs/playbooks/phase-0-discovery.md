...
> **Duration**: 3-7 days | **NEXUS Mode**: Full | **Agents**: 6 | **Gate Keeper**: Executive Summary Generator
...
> Early catch points — prevent surprises in Phase 4. See [Cross-Cutting Concerns Register](../coordination/cross-cutting-concerns.md).

- [ ] **Compliance**: Legal Compliance Checker identifies blocking regulations NOW. Any "showstopper" regulation must be flagged in the Executive Summary
- [ ] **Privacy**: Data handling constraints (GDPR/CCPA/PIPL) mapped before architecture decisions lock them in
- [ ] **Tech Risk**: Tool Evaluator flags tech choices with known security/performance limitations
- [ ] **Market Risk**: Trend Researcher identifies competitors that have failed — what can we learn?
