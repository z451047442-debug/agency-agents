...
> **Note**: This table lists only the agents referenced in the NEXUS pipeline. The Agency has 65 categories and 1,363 agents — see `divisions.json` and `AGENTS.json` for the full catalogue. Per-phase agent rosters (Sections 3-9) reflect the complete NEXUS-eligible set.
