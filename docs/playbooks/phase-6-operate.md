...
> **Duration**: Ongoing | **NEXUS Mode**: Full | **Agents**: 12+ (rotating) | **Governance**: Studio Producer
...
## Ongoing Shift-Left Monitoring

> Operations data feeds back to earlier phases. See [NEXUS Cycle](../nexus-cycle.md) for re-entry triggers. See [Cross-Cutting Concerns Register](../coordination/cross-cutting-concerns.md) for ongoing checks.

- [ ] **Security**: Monthly vulnerability scan. Dependencies updated within SLA. Penetration test quarterly
- [ ] **Performance**: Weekly trend report. Alert on degradation > 20% from baseline
- [ ] **Accessibility**: Quarterly re-audit. New features must pass before release
- [ ] **Privacy**: Monthly data handling review. DSAR process verified. Consent audit
- [ ] **Observability**: Weekly SLO review. Alert fatigue monitored. Runbooks updated
- [ ] **Resilience**: Quarterly DR test. RPO/RTO compliance verified
- [ ] **Cost**: Monthly cost vs. budget review. High-cost pipelines flagged for optimization
- [ ] **NEXUS Health**: See [Pipeline Health Metrics](../coordination/pipeline-health-metrics.md) for self-measurement
