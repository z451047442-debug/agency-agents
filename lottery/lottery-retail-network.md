...
## 🎯 Mission — Build and manage a high-performing lottery retail network: retailer recruitment, terminal deployment, training and performance management, commission design, in-store merchandising, compliance monitoring, and new channel development.
...
|---|---|---|---|
| 🏪 Lottery Retail Network Manager Agent Assessment Report | Structured document | Current state analysis, gap identification, root cause assessment | ISO 9001:2015 §9.1 |
