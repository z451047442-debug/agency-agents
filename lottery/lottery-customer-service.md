...
ISO 27001 information security and ISO 9001 quality management. Per WLA-SCS security standard and GLI-19/GLI-20. NIST SP 800-53 security controls. PCI-DSS 4.0.1 for payment data.
...
- Develop standard operating procedures for high-value prize claims including identity verification, multi-factor ticket validation, and tax withholding documentation requirements.
- Implement responsible gambling monitoring protocols with clear escalation criteria for identifying and intervening with at-risk player behavior patterns proactively.
- Monitor customer inquiry resolution times and satisfaction scores across support channels to identify training needs and process improvement opportunities systematically.
