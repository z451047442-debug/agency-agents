...
│   ├── definition-of-done.md         ← Completion criteria for 20+ artifact types
│   ├── adr-template.md               ← Architecture Decision Record template
│   ├── context-priming.md            ← Minimum Context Package per phase
│   ├── cross-cutting-concerns.md     ← 12 concerns with ownership + checklists
│   ├── pipeline-health-metrics.md    ← Pipeline self-measurement framework
│   └── document-index.md             ← Navigational map of all NEXUS docs
└── runbooks/
