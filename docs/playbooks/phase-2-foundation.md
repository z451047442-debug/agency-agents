...
> **Duration**: 3-5 days | **NEXUS Mode**: Full | **Agents**: 6 | **Gate Keepers**: DevOps Automator + Evidence Collector
...
> Foundation-phase checks — catch issues before Phase 3 mass-build. See [Cross-Cutting Concerns Register](../coordination/cross-cutting-concerns.md).

- [ ] **Security**: Auth system functional. Secrets management in place. Dependency scanning in CI. SAST configured
- [ ] **Performance**: Performance baseline measured and recorded. LCP budget in CI. Lighthouse check in pipeline
- [ ] **Accessibility**: Design system includes focus indicators, contrast ratios, semantic HTML. axe-core in CI
- [ ] **Observability**: Monitoring dashboards live. Alerting configured. Log aggregation working
- [ ] **Privacy**: Encryption at rest + in transit verified. Data retention policies configured
- [ ] **Resilience**: RPO/RTO targets defined. Backup strategy implemented
- [ ] **ADR**: DevOps Automator writes ≥1 ADR for CI/CD and infrastructure decisions
