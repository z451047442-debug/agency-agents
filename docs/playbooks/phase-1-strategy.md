...
> **Duration**: 5-10 days | **NEXUS Mode**: Full | **Agents**: 8 | **Gate Keepers**: Studio Producer + Reality Checker
...
> Architecture-phase checks to prevent late-phase rework. See [Cross-Cutting Concerns Register](../coordination/cross-cutting-concerns.md).

- [ ] **Security**: Threat model produced (STRIDE or similar). Security requirements in architecture spec. Auth/encryption strategy defined
- [ ] **Privacy**: Data flow diagram includes PII identification. Consent requirements per jurisdiction mapped
- [ ] **i18n/L10n**: Target locales decided. i18n library chosen. RTL support evaluated if applicable
- [ ] **Performance**: Performance budget defined (LCP < 2.5s, P95 < 200ms). Scalability model documented
- [ ] **Brand**: Brand Foundation complete before any UI work starts
- [ ] **ADRs**: ≥2 ADRs written by Backend Architect, ≥1 by UX Architect. See [ADR Template](../coordination/adr-template.md)
