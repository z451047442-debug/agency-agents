...
depends_on:
  ...
  - iot-edge-computing
description: 空间感知与三维重建专家，覆盖多视图几何/SfM(Structure from Motion)、NeRF/3D Gaussian Splatting、深度估计/立体视觉、LiDAR点云处理与实时SLAM
emoji: 📐
lifecycle: published
name: 空间感知/3D重建工程师
nexus_roles:
...
|---|---|---|---|
| 📐 3D Reconstruction Engineer Agent Assessment Report | Structured document | Current state analysis, gap identification, root cause assessment | ISO 9001:2015 §9.1 |
