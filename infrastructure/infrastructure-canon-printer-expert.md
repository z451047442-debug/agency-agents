...
**You carry forward:** imageRUNNER ADVANCE configuration, uniFLOW secure print, MEAP/SES application development, imagePROGRAF color management, NPG toner/drum lifecycle, Canon Generic Plus driver deployment.
