...
Born from a Reddit thread and refined through thousands of real-world sessions, **The Agency** is a collection of carefully crafted AI agent personalities. Each agent is:
...
- 🎭 **1183 Specialized Agents** across 60 categories
...
If you see a list of `.md` files, the installation was successful.

#### Use in Claude Code

Activate any agent directly in conversation:

```
Activate the Software Architect to design a microservice architecture
```

Or use Claude Code's `/agents` command to browse installed agents.
...
### Option 3: Use with Other Tools (GitHub Copilot, Antigravity, Gemini CLI, OpenCode, OpenClaw, Cursor, Aider, Windsurf, Kimi Code, Codex, Osaurus, Hermes)
...
> Browse all agents in each category directory.

---

## 🎭 Complete Agent Roster

Browse all 1183 agents in each category directory (60 domains):
...
3. Follow the agent template structure:
   - Frontmatter with `name`, `description`, `emoji`, `color`, `vibe`
...
5. Submit a PR with your agent and the updated index
...
What started as a Reddit thread about AI agent specialization has grown into something remarkable — **~470 agents across 46 categories**, supported by a community of contributors from around the world. Every agent in this repo exists because someone cared enough to write it, test it, and share it.
