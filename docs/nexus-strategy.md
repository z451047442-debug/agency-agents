...
16. [Supporting Documents & Templates](#16-supporting-documents--templates)
...
| **Operations** (operations/) | Support Responder (customer-service/), Analytics Reporter, Finance Tracker, Infrastructure Maintainer, Legal Compliance Checker, Executive Summary Generator | Sustain operations, compliance, and business intelligence |
...
> **Note**: This table lists only the agents referenced in the NEXUS pipeline. The Agency has 62 categories and 1,399 agents — see `divisions.json` and `AGENTS.json` for the full catalogue. Per-phase agent rosters (Sections 3-9) reflect the complete NEXUS-eligible set.
...
| Executive summary delivered | GO/NO-GO/PIVOT recommendation | Executive Summary Generator output |
...
| Security architecture defined | Threat model + security controls documented | Backend Architect + Security review |
| Compliance requirements integrated | Regulatory requirements mapped to architecture | Legal Compliance Checker |
...
| Theme toggle functional | Light/dark/system modes working | Evidence Collector screenshots |
| Git workflow documented | Branch strategy + PR process in place | Studio Operations documentation |
...
| All acceptance criteria met | 100% of sprint backlog criteria | Evidence Collector per-task verification |
| Code review completed | All PRs reviewed and approved | Code review logs |
...
| Infrastructure ready | Production environment validated | Infrastructure Maintainer report |
| Specification compliance | 100% of spec requirements | Point-by-point verification |
| Performance certified | P95 < 200ms, LCP < 2.5s, uptime > 99.9% | Load test results |
...
| **Support Responder** | Customer support during launch | Support ticket handling, issue triage |
| **Analytics Reporter** | Real-time metrics | Launch dashboards, KPI tracking |
| **Feedback Synthesizer** | Early user feedback collection | User sentiment report, issue clustering |
| **Infrastructure Maintainer** | Launch monitoring | Real-time dashboards |
| **Experiment Tracker** | A/B test management | Experiment results, variant performance |
...
| Support operational | Support Responder active, response time < 1h | Support dashboard |
| Growth metrics tracking | Channel reports active, acquisition data flowing | Growth Hacker dashboard |
...
| **DevOps Automator** | Continuous | Deployment pipeline maintenance, infrastructure updates |
| **Project Shepherd** | Weekly | Cross-team coordination, milestone tracking |
| **Content Creator** | Bi-weekly | Content updates, changelog, release notes |
| **Brand Guardian** | Monthly | Brand consistency audit, guideline updates |
| **Studio Producer** | Monthly | Strategic review, portfolio alignment |
| **Performance Benchmarker** | Quarterly | Performance trending, capacity planning |
| **Tool Evaluator** | Quarterly | Tool stack assessment, new technology evaluation |
...
#   + Instagram Curator + Reddit Community Builder → Evidence Collector (QA)
#
# Performance Issue:
...
| Document | Purpose |
|----------|---------|
| [Definition of Done](coordination/definition-of-done.md) | Completion criteria for 20+ artifact types |
| [ADR Template](coordination/adr-template.md) | Architecture Decision Record template + lifecycle |
| [Context Priming](coordination/context-priming.md) | Minimum Context Package per phase |
| [Cross-Cutting Concerns](coordination/cross-cutting-concerns.md) | 12 concerns with ownership + checklists |
| [Pipeline Health Metrics](coordination/pipeline-health-metrics.md) | Pipeline self-measurement |
| [Document Index](coordination/document-index.md) | Complete navigational map of all NEXUS docs |
| [Handoff Templates](coordination/handoff-templates.md) | 7 agent-to-agent handoff templates |
| [Agent Activation Prompts](coordination/agent-activation-prompts.md) | Ready-to-use prompt templates |
| [NEXUS Cycle](nexus-cycle.md) | Closed-loop Operate→Discovery feedback |
| [Rollback Runbook](runbooks/scenario-rollback-recovery.md) | Rollback decision tree + execution protocol |

### Team Templates (docs/teams/)
| Template | Scenario |
|----------|----------|
| [agile-dev-team](teams/agile-dev-team.md) | Sprint agile development |
| [ecommerce-launch-team](teams/ecommerce-launch-team.md) | Ecommerce platform launch |
| [mobile-app-team](teams/mobile-app-team.md) | Mobile app development |
| [data-platform-team](teams/data-platform-team.md) | Data platform build |
| [ai-product-team](teams/ai-product-team.md) | AI product development |
| [compliance-audit-team](teams/compliance-audit-team.md) | Compliance audit |
| [content-marketing-team](teams/content-marketing-team.md) | Content marketing |
| [security-incident-team](teams/security-incident-team.md) | Security incident response |
| [ipo-preparation-team](teams/ipo-preparation-team.md) | IPO preparation |
| [smart-factory-team](teams/smart-factory-team.md) | Smart factory construction |
...
### Operations Division — "Sustain It"
| Agent | Superpower | Activation Trigger |
|-------|-----------|-------------------|
...
|----------|--------|--------|----------|
| Agent activations (estimated token cost) | — | — | — |
| Infrastructure (cloud, CI/CD minutes) | — | — | — |
| External services (APIs, tools) | — | — | — |
| Total | — | — | — |
- **Cost per task** (avg): —
- **Cost per phase**: —
- **High-cost tasks** (top 5 by retry × activation cost): [List]
