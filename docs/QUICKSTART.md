...
|----------|---------|----------|
| **Master Strategy** | Complete NEXUS doctrine | `docs/nexus-strategy.md` |
| **Phase 0 Playbook** | Discovery & intelligence | `docs/playbooks/phase-0-discovery.md` |
| **Phase 1 Playbook** | Strategy & architecture | `docs/playbooks/phase-1-strategy.md` |
| **Phase 2 Playbook** | Foundation & scaffolding | `docs/playbooks/phase-2-foundation.md` |
| **Phase 3 Playbook** | Build & iterate | `docs/playbooks/phase-3-build.md` |
| **Phase 4 Playbook** | Quality & hardening | `docs/playbooks/phase-4-hardening.md` |
| **Phase 5 Playbook** | Launch & growth | `docs/playbooks/phase-5-launch.md` |
| **Phase 6 Playbook** | Operate & evolve | `docs/playbooks/phase-6-operate.md` |
| **Activation Prompts** | Ready-to-use agent prompts | `docs/coordination/agent-activation-prompts.md` |
| **Handoff Templates** | Standardized handoff formats | `docs/coordination/handoff-templates.md` |
| **Startup MVP Runbook** | 4-6 week MVP build | `docs/runbooks/scenario-startup-mvp.md` |
| **Enterprise Feature Runbook** | Enterprise feature development | `docs/runbooks/scenario-enterprise-feature.md` |
| **Marketing Campaign Runbook** | Multi-channel campaign | `docs/runbooks/scenario-marketing-campaign.md` |
| **Incident Response Runbook** | Production incident handling | `docs/runbooks/scenario-incident-response.md` |
...
Feedback Synthesizer│ Studio Operations   │ Test Results Analyzer
                    ...
                    │                     │ Workflow Optimizer
────────────────────┼─────────────────────┼──────────────────────
OPERATIONS          │ SPATIAL             │ SPECIALIZED
Support Responder   │ XR Interface Arch.  │ Agents Orchestrator
Analytics Reporter  │ macOS Spatial/Metal │ LSP/Index Engineer
Finance Tracker     │ XR Immersive Dev    │ Sales Data Extraction
Infra Maintainer    │ XR Cockpit Spec.    │ Data Consolidation
Legal Compliance    │ visionOS Spatial    │ Report Distribution
...
`docs/nexus-strategy.md` — The complete doctrine
